            ...
            <dl>
                ...
                <?php foreach ($v['list'] as $key => $value) { ?>
                    <dd><a href="javascript:void(0)"
                           onclick="openItem('<?php echo $value['args'] ?>')"><?php echo $value['text']; ?></a></dd>
                <?php } ?>
            </dl>
        <?php } ?>
    </div>
...
<table style="width: 100%;" id="frametable" height="100%" width="100%" cellpadding="0" cellspacing="0">
        ...
        <td colspan="2" height="90" class="mainhd">
            <div class="layout-header"> <!-- Title/Logo - can use text instead of image -->
                ...
                <div id="topnav" class="top-nav">
                    <ul>
                        <li class="adminid"
                            title="<?php echo $lang['nc_hello']; ?>:<?php echo $output['admin_info']['name']; ?>"><?php echo $lang['nc_hello']; ?>
                            &nbsp;:&nbsp;<strong><?php echo $output['admin_info']['name']; ?></strong></li>
                        <li><a href="index.php?act=index&op=modifypw"
                               target="workspace"><span><?php echo $lang['nc_modifypw']; ?></span></a></li>
                        <li><a href="index.php?act=index&op=logout"
                               title="<?php echo $lang['nc_logout']; ?>"><span><?php echo $lang['nc_logout']; ?></span></a>
                        </li>
                        <li><a href="<?php echo BASE_SITE_URL; ?>" target="_blank"
                               title="<?php echo $lang['nc_homepage']; ?>"><span><?php echo $lang['nc_homepage']; ?></span></a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="loca"><strong><?php echo $lang['nc_loca']; ?>:</strong>
                    <div id="crumbs" class="crumbs"><span><?php echo $lang['nc_console']; ?></span><span class="arrow">&nbsp;</span><span><?php echo $lang['nc_welcome_page']; ?></span>
                    </div>
                </div>
                <div class="toolbar">
                    ...
                    <div class="sitemap"><a id="siteMapBtn" href="#rhis"
                                            onclick="showBg('dialog','dialog_content');"><span><?php echo $lang['nc_sitemap']; ?></span></a>
                    </div>
                    <div class="toolmenu"><span class="bar-btn"></span>
                        <ul class="bar-list">
                            <li><a onclick="openItem('clear,cache,setting');"
                                   href="javascript:void(0)"><?php echo $lang['nc_update_cache']; ?></a></li>
                            <li><a href="<?php echo ADMIN_SITE_URL; ?>"
                                   id="iframe_refresh"><?php echo $lang['nc_refresh']; ?><?php echo $lang['nc_admincp']; ?></a>
                            </li>
                            <li><a href="<?php echo ADMIN_SITE_URL; ?>"
                                   title="<?php echo $lang['nc_admincp']; ?>-<?php echo $output['html_title']; ?>"
                                   rel="sidebar"
                                   onclick="addFavorite('<?php echo ADMIN_SITE_URL; ?>', '<?php echo $lang['nc_admincp']; ?>-<?php echo $output['html_title']; ?>');return false;"><?php echo $lang['nc_favorite']; ?><?php echo $lang['nc_admincp']; ?></a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <tr>
        <td class="menutd" valign="top" width="161">
            ...
            <div class="copyright" style="display:none">本程序来源于www.3 3 hao.com，淘宝店：http:// 33ha ocom.tao bao.com，旺旺:33
                hao，Q Q-1-2-4-4-9-8-6-4-0
            </div>
        </td>
        <td valign="top" width="100%">
            <iframe src="" id="workspace" name="workspace" style="overflow: visible;" frameborder="0" width="100%"
                    height="100%" scrolling="yes" onload="window.parent"></iframe>
        </td>
    </tr>
    </tbody>
</table>
