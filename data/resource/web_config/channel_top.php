  ...
  <div class="channel-category"> 
    <ul class="menu">
      ...
      <li cat_id="<?php echo $val['gc_parent']['gc_id'];?>" class="<?php echo $i%2==1 ? 'odd':'even';?>" <?php if($i>6){?>style="display:none;"<?php }?>>
        ...
        <div class="pic"><img src="<?php echo UPLOAD_SITE_URL;?>/shop/common/loading.gif" rel="lazy" data-url="<?php echo UPLOAD_SITE_URL.'/'.$val['gc_parent']['gc_pic'];?>"></div>
        <?php } ?> 
  ...
  <div class="jfocus-trigeminy">
    <ul>
      ...
      <li>
        ...
        <a href="<?php echo $v['pic_url'];?>" target="_blank" title="<?php echo $v['pic_name'];?>"> <img src="<?php echo UPLOAD_SITE_URL;?>/shop/common/loading.gif" rel="lazy" data-url="<?php echo UPLOAD_SITE_URL.'/'.$v['pic_img'];?>" alt="<?php echo $v['pic_name'];?>"></a>
        <?php } ?>
      </li>
      <?php } ?>
      <?php } ?>
