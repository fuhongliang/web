...
<div class="channel-standard-layout wrapper style-<?php echo $output['web_id'];?>">
  <div class="left-sidebar">
    ...
    <div class="left-ads">
      ...
      <a href="<?php echo $output['code_channel_act']['code_info']['url'];?>" title="<?php echo $output['code_channel_act']['code_info']['title'];?>" target="_blank"> <img src="<?php echo UPLOAD_SITE_URL;?>/shop/common/loading.gif" rel="lazy" data-url="<?php  echo UPLOAD_SITE_URL.'/'.$output['code_channel_act']['code_info']['pic'];?>" alt="<?php echo $output['code_channel_act']['code_info']['title']; ?>"> </a>
      <?php } ?>
    </div>
  </div>
      ...
      <ul>
        ...
        <li>
          <dl>
            ...
            <dd class="goods-thumb"> <a target="_blank" href="<?php echo urlShop('goods','index',array('goods_id'=> $v['goods_id'])); ?>"> <img src="<?php echo UPLOAD_SITE_URL;?>/shop/common/loading.gif" rel="lazy" data-url="<?php echo strpos($v['goods_pic'],'http')===0 ? $v['goods_pic']:UPLOAD_SITE_URL."/".$v['goods_pic'];?>" alt="<?php echo $v['goods_name']; ?>" /> </a></dd>
  ...
  <div class="right-sidebar">
    <div class="picture">
      ...
      <img src="<?php echo UPLOAD_SITE_URL;?>/shop/common/loading.gif" rel="lazy" data-url="<?php echo UPLOAD_SITE_URL.'/'.$output['code_adv_a']['code_info']['pic'];?>"/>
      </a>
      <?php } ?>
    </div>
    <div class="picture">
      ...
      <img src="<?php echo UPLOAD_SITE_URL;?>/shop/common/loading.gif" rel="lazy" data-url="<?php echo UPLOAD_SITE_URL.'/'.$output['code_adv_b']['code_info']['pic'];?>"/>
      </a>
      <?php } ?>
    </div>
    <div class="picture">
      ...
      <img src="<?php echo UPLOAD_SITE_URL;?>/shop/common/loading.gif" rel="lazy" data-url="<?php echo UPLOAD_SITE_URL.'/'.$output['code_adv_c']['code_info']['pic'];?>"/>
      </a>
      <?php } ?>
    </div>
  </div>
