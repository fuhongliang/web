...
$(function() {
	...
	$("#goods_search").attr("href", "store_search.html?store_id=" + e);
	$("#store_categroy").attr("href", "store_search.html?store_id=" + e);
	$("#store_intro").attr("href", "store_intro.html?store_id=" + e);
