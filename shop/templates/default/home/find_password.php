        ...
        <div id="default" class="tabs-content">
          <form class="nc-login-form" action="index.php?act=login&op=find_password" method="POST" id="find_password_form">
            ...
            <div class="code-div mt15">
              ...
              <span><img src="index.php?act=seccode&op=makecode&type=50,120&nchash=<?php echo getNchash();?>" title="<?php echo $lang['login_index_change_checkcode'];?>" name="codeimage" id="codeimage"> <a class="makecode ml5" href="javascript:void(0);" onclick="javascript:document.getElementById('codeimage').src='index.php?act=seccode&op=makecode&type=50,120&nchash=<?php echo getNchash();?>&t=' + Math.random();"><?php echo $lang['login_password_change_code']; ?></a></span></div>
