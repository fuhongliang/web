...
<div class="goods-guess-like">
  ...
  <div class="content">
    ...
    <ul id="mycarousel" class="jcarousel-skin-tango">
      ...
      <li>
        <div class="goods-pic"> <a href="<?php echo urlShop('goods','index',array('goods_id'=>$v['goods_id']));?>" target="_blank"><img alt="" src="<?php echo UPLOAD_SITE_URL;?>/shop/common/loading.gif" rel="lazy" data-url="<?php echo cthumb($v['goods_image'], 240);?>"></a> </div>
