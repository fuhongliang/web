  ...
  <div class="ncg-content">
    <div class="ncg-slides-banner">
      <ul id="fullScreenSlides" class="full-screen-slides">
        ...
        <li><a href="<?php echo $p[1];?>" target="_blank"><img src="<?php echo UPLOAD_SITE_URL;?>/shop/common/loading.gif" rel="lazy" data-url="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_LIVE.'/'.$p[0];?>"></a></li>
        <?php }?>
        <?php }?>
      </ul>
    </div>
    <div class="group-list mt20">
      ...
      <ul>
        ...
        <li class="<?php echo $output['current'];?>">
          <div class="ncg-list-content"> <a title="<?php echo $groupbuy['groupbuy_name'];?>" href="<?php echo $groupbuy['groupbuy_url'];?>" class="pic-thumb" target="_blank"><img src="<?php echo UPLOAD_SITE_URL;?>/shop/common/loading.gif" rel="lazy" data-url="<?php echo gthumb($groupbuy['groupbuy_image'],'mid');?>" alt=""></a>
    ...
    <div class="group-list mt30">
      ...
      <ul>
        ...
        <li class="<?php echo $output['current'];?>">
          <div class="ncg-list-content"> <a title="<?php echo $groupbuy['groupbuy_name'];?>" href="<?php echo urlShop('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$groupbuy['groupbuy_id']));?>" class="pic-thumb" target="_blank"><img src="<?php echo UPLOAD_SITE_URL;?>/shop/common/loading.gif" rel="lazy" data-url="<?php echo lgthumb($groupbuy['groupbuy_pic'],'mid');?>" alt=""></a>
