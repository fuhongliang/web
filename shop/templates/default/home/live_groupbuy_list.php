    ...
    <div class="group-list">
      <ul>
        ...
        <li class="<?php echo $output['current'];?>">
          ...
          <a title="<?php echo $groupbuy['groupbuy_name'];?>" href="<?php echo urlShop('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$groupbuy['groupbuy_id']));?>" class="pic-thumb" target="_blank"><img src="<?php echo UPLOAD_SITE_URL;?>/shop/common/loading.gif" rel="lazy" data-url="<?php echo lgthumb($groupbuy['groupbuy_pic'],'mid');?>" alt=""></a>
