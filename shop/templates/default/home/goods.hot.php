...
<div class="nch-module nch-module-style01">
  ...
  <div class="content">
    ...
    <ul class="v_module_recommend">
      ...
      <li>
        <div class="goods-pic"><a href="<?php echo urlShop('goods','index',array('goods_id'=>$value['goods_id']));?>" target="_blank"><img alt="<?php echo $value['goods_name'];?>" src="<?php echo UPLOAD_SITE_URL;?>/shop/common/loading.gif" rel="lazy" data-url="<?php echo thumb($value, 240);?>"></a> </div>
        <dl class="goods-info">
